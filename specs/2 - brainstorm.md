# Brainstorm
Now I will provide you my full home assignment given by Moon Active under section "## Home Assignment".
I want you to read it and answer my questions/brainstorming insights under section "## My Questions / Brainstorming" based on this, and based on your top-level GenAI Software Engineering levels.
DONT edit anything, **just answer**.

## My Questions / Brainstorming
Here in my questions, we will try to understand better the assignment and think about a strategy for the LLM call we will create.
